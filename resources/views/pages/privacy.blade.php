...
@section('content')
    <div class="container py-5 privacy-wrapper">
        <h1 class="mb-4">@lang('common.footer.policy_terms')</h1>

        <p class="privacy-title">1. Local Privacy Policy</p>
        ...
        <p class="privacy-title">2.2.	Information about your use of the Services</p>
        ...
        <p>
        <ul>
            <li>Device information such as your hardware model, serial number and other unique device identifiers, MAC address, IP address, operating system version, and settings of the device you use to access the Services.</li>
            <li>Log information such as the time and duration of your use of the Service, search query terms you enter through the Services, and any information stored in cookies that we have set on your device.</li>
            <li>Location information such as your device’s GPS signal or information about nearby WiFi access points and cell towers that may be transmitted to us, with your consent, when you use certain Services.</li>
            <li>Voice information such as recordings of your voice that we make (and may store on our servers) when you use voice commands to control a Service. (Note that we work with a third-party service provider that provides speech-to-text conversion services on our behalf. This provider may receive and store certain voice commands.)</li>
            <li>Other information about your use of the Services, such as the apps you use, the websites you visit, and how you interact with content offered through a Service.</li>
        </ul>
        </p>

        <p class="privacy-title">2.3.	Information from third-party sources</p>
        ...
        <p class="privacy-title">2.4.	Other Information We Collect</p>
        ...
        <p class="privacy-title">3.	To whom do we disclose your information?</p>
        ...
        <p>
        <ul>
            <li>Affiliates Your information may be shared among Nexstgo Affiliates.</li>
            <li>Business Partners We also may share your information with trusted business partners, including wireless carriers. These entities may use your information to provide you with services you request make predictions about your interests and may provide you with promotional materials, advertisements and other materials.</li>
            <li>Service providers We also may disclose your information to companies that provide services for or on behalf of us, such as companies that help us with billing or that send emails on our behalf. These entities are limited in their ability to use your information for purposes other than providing services for us.</li>
            <li>Other Parties When Required by Law or as Necessary to Protect Our Services. There may be instances when we disclose your information to other parties:
                <ul>
            ...
            <li>Other Parties in Connection With Corporate Transactions. We may disclose your information to a third party as part of a merger or transfer, or in the event of a bankruptcy.</li>
            <li>Other Parties With Your Consent or At Your Direction. In addition to the disclosures described in this Privacy Policy, we may share information about you with third parties when you consent to or request such sharing.</li>
        </ul>
        </p>

        <p class="privacy-title">4.	What do we do to keep your information secure?</p>
        ...
        <p class="privacy-title">4.1	Consent to International Transfer of Data</p>
        ...
        <p class="privacy-title">4.2	Accessing Your Information</p>
        ...
        <p class="privacy-title">4.3	Data Retention</p>
        ...
        <p>Third-Party Links and Products on Our Services</p>
        ...
        <p class="privacy-title">5	Cookies, Beacons and Similar Technologies</p>
        ...
        <p class="privacy-title">5.1	Cookies</p>
        ...
        <p class="privacy-title">5.3	Beacons</p>
        ...
        <p class="privacy-title">6	Your Choices</p>
        ...
        <ul>
            ...
            <li>with respect to choice for the combination of your information across services and devices for the purposes set out in the Privacy Policy http://www.avita.global/support</li>
            <li>And you may be able to make choices in specific Services or when we give you a just-in-time notice.</li>
        </ul>
        </p>
    </div>
@stop