...
@push('css')
    ...
    <style>
        ...
        .sub-banner-section .cms-banner-1 .main-banner{
            background-image: url(/images/sx14/kachi_1920_1_c_sx14.jpg);
        }
		.sub-banner-section .cms-banner-2 .main-banner{
            background-image: url(/images/sx14/kachi_1920_2_c_sx14.jpg);
        }
		.sub-banner-section .cms-banner-3 .main-banner{
            background-image: url(/images/sx14/kachi_1920_3_c_sx14.jpg);
        }
		.sub-banner-section .cms-banner-4 .main-banner{
            background-image: url(/images/sx14/kachi_1920_4_c_sx14.jpg);
        } 
        ...
        @media(max-width: 991px) {
            .sub-banner-section .cms-banner-1 .main-banner{
            background-image: url(/images/sx14/kachi_911_1_c_sx14.jpg);
            }
			.sub-banner-section .cms-banner-2 .main-banner{
            background-image: url(/images/sx14/kachi_911_2_c_sx14.jpg);
            }
			.sub-banner-section .cms-banner-3 .main-banner{
            background-image: url(/images/sx14/kachi_911_3_c_sx14.jpg);
            }
			.sub-banner-section .cms-banner-4 .main-banner{
            background-image: url(/images/sx14/kachi_911_4_c_sx14.jpg);
            }
	...
	<section class="pt-section d-flex flex-wrap text-center text-white p-0 sx14_bg2">
        <div class="container">
                <div class="col-12 col-lg-12 py-5 order-2 order-lg-2" >
                    <div class="d-flex flex-wrap flex-column align-items-center justify-content-center h-100">
                        <h2 class="pt-title mt-4">超卓六核</h2>
                        <hr class="pt-title-hr bg-white">
                        <div class="pt-content-wrapper-lg mx-auto">   
						<p class="pt-content-title mx-auto">表現出類拔萃</p>						
                            <p class="pt-content mx-auto" style="color: #fff; text-align:left;">
                            配備第10代Comet Lake Intel® Core<sup>TM</sup> 六核心處理器，配合VAIO TruePerformance技術，性能更顯超卓。
                            </p>
                        </div>
                    </div>
                </div>
...
<!---------------------------------------------------------------->   
	...
	<section class="pt-section d-flex flex-wrap text-center p-0" >
                ...
                <div class="col-12 col-lg-8 " style="background-color: #ddd;">
                    <div class="d-flex flex-wrap flex-column align-items-center justify-content-center h-100">
                        ...
                        <div class="pt-content-wrapper-lg mx-auto">                            
                            ...
                            <p class="pt-content mx-auto" >VAIO SX14內置全新臉部識別功能及指紋識別器，助你彈指之間安全登入。如此嚴密的保安設計能杜絕一切惡意入侵。</p>
                            <p class="pt-content-sm" style="font-size: 0.8rem;">* 臉部識別功能僅適用於10代處理器版本。</p>
                            <div class="col-12 mb_only">
                ...
                <div class="col-12 win-hello" >
                        ...
                        <hr class="pt-title-hr">                     
                        <p class="pt-content mx-auto">使用Windows Hello登入快捷、安全可靠、無需密碼。</p>
                </div>
