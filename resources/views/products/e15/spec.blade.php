    ...
    <section style="background-color: #ededed;">
        <div class="container">
            <nav class="nav nav-tabs" role="tablist">
                <a href="#spec-1" class="text-center spec-product nav-link nav-item col-6 active" data-toggle="tab" role="tab">
                    <h3 class="spec-product-name mb-4 pt-5 pt-lg-0">VAIO® S11</h3>
                    <img src="/images/banner/S11vaio-black.png" class="my-5" alt="VAIO® S11">
                    <ul class="color-pick-list list-unstyled d-flex flex-wrap mx-auto align-items-center justify-content-center">
                        <li class="color-pick active" style="background-color: #37383a" data-src="/images/banner/S11vaio-black.png"></li>
                        <li class="color-pick" style="background-color: #dbdcde" data-src="/images/banner/S11vaio-silver.png"></li>
                        <li class="color-pick" style="background-color: #926c65" data-src="/images/banner/S11vaio-brown.png"></li>
                        <li class="color-pick" style="background-color: #dda4aa" data-src="/images/banner/S11vaio-pink.png"></li>
                        <li class="color-pick" style="background-color: #eeeeee" data-src="/images/banner/S11vaio-white.png"></li>
                    </ul>
                </a>

                <a href="#spec-2" class="text-center spec-product nav-item nav-link col-6" data-toggle="tab" role="tab">
            ...
            <div class="container">
                <ul class="list-unstyled spec-list">
                    <li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">Black, Silver, Brown, Sakura Pink, White</div>
                    </li>
                    <li class="spec-item d-flex">
                        <div class="offset-md-1 col-4 col-md-3 spec-item-name">CPU
                            <sub>1</sub>
                        </div>
                        <div class="offset-md-1 spec-item-content">8th Gen Intel® Core™ i5-i7 Processor
                            <br>- Trusted Platform Module (TPM): TCG Ver. 2.0</div>
                    </li>
                    <li class="spec-item d-flex">
                    ...
                    <li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">11.6" FHD IPS (1920 x 1080)
