    ...
    <section class="top-nav-padding" style="background-color:white; margin-top: 50px;">
        ...
        <div class="container py-5">
          ...
          <!---  <h2 class="page-title mb-5">Stay Tuned For More</h2> ------>
            ...
            <div class="row">
            <a class="px-md-4 py-2" target="_blank" href="https://www.flipkart.com/vaio-laptops-store?otracker=clp_banner_1_4.banner.BANNER_laptops-store_I9MXHU2TP6HG"> <img src="images/flipkart-logo.jpeg" id="desktop" alt="Where to Buy" width="30%" /></a>
