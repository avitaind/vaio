...
@section('title', 'VAIO SE14 2021 Specification')
        ...
        <div class="container">
            <nav class="nav nav-tabs">
                <a href="#spec-1" class="text-center spec-product nav-link col-12 active" data-toggle="tab" role="tab">
                    <h3 class="spec-product-name mb-4 pt-5 pt-lg-0">VAIO&#174; SE14 2021</h3>
            ...
            <div class="container">
                <ul class="list-unstyled spec-list">
					...
					<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">Windows Home</div>
                    </li>
                    <li class="spec-item d-flex">
                        <div class="offset-md-1 col-4 col-md-3 spec-item-name">CPU<sup>1</sup></div>
                        <div class="offset-md-1 spec-item-content">11th Gen Intel® Core™ Processor<br>i5-1135G7<br>i7-1165G7</div>
                    </li>
					 <li class="spec-item d-flex">
					...
					<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">14" 16:9 Full HD Anti-Glare IPS Panel (1920x1080) with wide viewing angle</div>
                    </li>
					<li class="spec-item d-flex">
					...
					<!--<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">Micro-SD Card Reader (SD/SDHC/SDXC)</div>
                    </li> -->
					<li class="spec-item d-flex">
                        <div class="offset-md-1 col-4 col-md-3 spec-item-name">Battery life<sup>4</sup></div>
                        <div class="offset-md-1 spec-item-content">Up to 12 hours</div>
                    </li>
					<li class="spec-item d-flex">
					...
					<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">Approx. 1.39kg</div>
                    </li>
					<li class="spec-item d-flex">
                        <div class="offset-md-1 col-4 col-md-3 spec-item-name">Accessories</div>
                        <div class="offset-md-1 spec-item-content">AC Adapter and Power cord<br/>Carry bag</div>
                    </li>					
