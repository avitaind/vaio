...
@section('title', 'VAIO SX14 ALL BLACK EDITION Specification')
        ...
        <div class="container">
            <nav class="nav nav-tabs">
                <a href="#spec-1" class="text-center spec-product nav-link col-12 active" data-toggle="tab" role="tab">
                    <h3 class="spec-product-name mb-4 pt-5 pt-lg-0">NEW VAIO&#174; SX14 ALL BLACK EDITION</h3>
                    <img src="/images/sx14_abe/000.png" class="my-4">                     
                    <ul class="color-pick-list list-unstyled d-flex flex-wrap mx-auto align-items-center justify-content-center">
                        <!--<li class="color-pick active" style="background-color: #000" data-src="/images/sx14_abe/000.png"></li>  -->
                    </ul>
                </a>
        ...
        <div class="container">
          <ul class="list-unstyled spec-list">
            <li class="spec-item d-flex">
              ...
              <div class="offset-md-1 spec-item-content">All Black</div>
            </li>
            <li class="spec-item d-flex">
