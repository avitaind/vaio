        ...
        <div class="container">
            <nav class="nav nav-tabs">
                ...
                <a href="#spec-2" class="text-center spec-product nav-link col-4" data-toggle="tab" role="tab">
                    ...
                    <ul class="color-pick-list list-unstyled d-flex flex-wrap mx-auto align-items-center justify-content-center">
                        <li class="color-pick active" style="background-color: #012d62" data-src="/images/sx12/sx12_kachiiro.png"></li>
                    </ul>
                </a>
      ...
      <div class="tab-pane mb-5" id="spec-3" role="tabpanel">
        <div class="container">
          <ul class="list-unstyled spec-list">
            ...
            <li class="spec-item d-flex">
              <div class="offset-md-1 col-4 col-md-3 spec-item-name">Battery Life<sup>4</sup></div>
              <div class="offset-md-1 spec-item-content">Approx. 12.00(h) with FHD display/ Approx. 6.00(h) with 4k display</div>
            </li>
            ...
            <li class="spec-item d-flex">
              <div class="offset-md-1 col-4 col-md-3 spec-item-name">Weight<sup>3</sup></div>
              <div class="offset-md-1 spec-item-content"> Approx. 1.06 (kg)</div>
            </li>
          </ul>
        </div>
      </div>
