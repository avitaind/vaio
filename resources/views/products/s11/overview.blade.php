        ...
        <div class="main-content container-fluid">
            ...
            <section class="pt-section text-center" id="pt-2">
                <div class="container">
                    ...
                    <img src="/images/pt-pic/pt02-1-en.png" class="mb-5" alt="VAIO TruePerformance Technology Optimises CPU Performances">
                    <div class="row">
                        <div class="mb-5 mb-lg-0 col-12 col-md-10 col-lg-6 mx-auto text-left d-flex flex-wrap align-items-start">
                            ...
                            <img src="/images/pt-pic/pt02-2-en.png" class="mt-auto" alt="VAIO TruePerformance CPU Performance Comparison CPU: Benchmark score with MAXON Cinebend Version 15.0.3.8">
                        </div>
                        <div class="col-12 col-md-10 col-lg-6 mx-auto text-left d-flex flex-wrap align-items-start">
                            ...
                            <img src="/images/pt-pic/pt02-3-en.png" class="mt-auto" alt="VAIO TruePerformance GPU Performance Comparison GPU: Benchmark score with Futuremark 3DMark 11 Version 1.0.132.0">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    ...
                    <div class="row mt-5">
                        <div class="mb-5 mb-lg-0 col-12 col-md-10 col-lg-6 mx-auto text-left d-flex flex-wrap align-items-start">
                            ...
                            <img src="/images/pt-pic/pt04-1-en.png" class="mt-auto" alt="SSD Performances Read/Write speed comparisons">
                        </div>
                        <div class="col-12 col-md-10 col-lg-6 mx-auto text-left d-flex flex-wrap align-items-start">
                            <h4 style="font-size: 1.3rem;color: #585858;">SSD Performances
                                <br>
                            ...
                            <img src="/images/pt-pic/pt04-2-en.png" class="mt-auto" alt="SSD Performances Time required to copy 1,000 documents from a folder to another (Seconds)">
                        </div>
                    </div>
