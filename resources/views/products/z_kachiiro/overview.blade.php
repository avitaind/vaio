...
<section class="main-banner-section" style="height: fit-content;">
    <div class="swiper-container-horizontal">
		<a href="javascript:void(0);" class="swiper-slide">
			...
			{{-- <div class="main-banner-wrapper cms-banner cms-banner-5" style="background-image:url(/images/z_kachiiro/vaio_z_kachiiro_banner_1920_720.jpg)"> --}}
...
@push('css')
    ...
    <style>
        ...
        .cms-banner-5 .main-banner {
            ...
            {{-- background-image: url(/images/z_kachiiro/vaio_z_kachiiro_banner_1920_720.jpg); --}}
        }
        @media(max-width: 991px) {
        .cms-banner-5 .main-banner {
            background-image: url(/images/z_kachiiro/vaio_z_kachiiro_banner_mo.jpg);
            {{-- background-image: url(/images/z_kachiiro/vaio_z_kachiiro_banner_mo_991_1050.jpg); --}}
            }
        }
