            ...
            <div class="wizard">
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="nav-item">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="@lang('member.step1')" class="nav-link disabled">
                        ...
                        <li role="presentation" class="nav-item">
                            <a href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="@lang('member.step3')" class="nav-link active">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step3">
                        <div class="row">
                            <h5 class="col-12 ml-md-5" style="line-height: 1.3;">@lang('member.product_registration_complete_message')</h5>
                        </div>
                    </div>
