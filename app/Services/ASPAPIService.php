...
class ASPAPIService
{
    ...
    public static function getSNRegistrationStatus( $serial_num, $model_num ){

        $client = self::getClient();

        $res = $client->request('GET', '/api/sn/check', [
            'headers' => ['Accept' => 'application/json'],
            'query' => ['serial_number' => $serial_num, 'model_number' => $model_num],
        ]);
...
//        }
     ...
     */
    public static function getProductModels( $product_number = null, $marketing_number = null) {
