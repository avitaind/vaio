            ...
            <div class="container">
                <ul class="list-unstyled spec-list">
					...
					<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">Windows 10 家用版 / 專業版</div>
                    </li>
                    <li class="spec-item d-flex">
                        <div class="offset-md-1 col-4 col-md-3 spec-item-name">CPU<sup>1</sup></div>
                        <div class="offset-md-1 spec-item-content">第8代Intel® Core™處理器<br>i3 – 8145U<br>i5 – 8265U<br>i7 – 8565U					
						</div>
                    </li>		
					<li class="spec-item d-flex">
					...
					<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">256GB / 512GB SSD</div>
                    </li>
					...
					<li class="spec-item d-flex">
                        ...
                        <div class="offset-md-1 spec-item-content">約 1.35Kg</div>
                    </li>
					<li class="spec-item d-flex">
