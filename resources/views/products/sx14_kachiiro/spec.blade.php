...
@section('title', 'VAIO SX14 | KACHI-IRO EDITION Specification')
        ...
        <div class="container">
            <nav class="nav nav-tabs">
                <a href="#spec-1" class="text-center spec-product nav-link col-12 active" data-toggle="tab" role="tab">
                    <h3 class="spec-product-name mb-4 pt-5 pt-lg-0">NEW VAIO&#174; SX14 | KACHI-IRO EDITION</h3>
                    <img src="/images/new_sx14/1c1c38.png" class="my-4" >                     
