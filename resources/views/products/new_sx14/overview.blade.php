...
<section class="main-banner-section" style="height: fit-content;">
    <div class="swiper-container-horizontal"> 
		<a href="javascript:void(0);" class="swiper-slide">
			<div class="main-banner-wrapper cms-banner cms-banner-5" style="background-image:url(/images/new_sx14/vaio_new_sx14_banner.jpg)">
...
@push('css')
    ...
    <style>
        ...
        .cms-banner-5 .main-banner {
            background-image: url(/images/new_sx14/vaio_new_sx14_banner.jpg);
        }
        @media(max-width: 991px) {
        .cms-banner-5 .main-banner {
            background-image: url(/images/new_sx14/vaio_new_sx14_banner_mo.jpg);
            }
        }
				...
				<div class="col-12 col-lg-6 py-5 order-1 order-lg-2" style="background-color: #fff;">
					<div class="d-flex flex-wrap flex-column align-items-center">
						...
						<div class="pt-content mx-auto text-left">
						    ...
						    <p class="pt-content text-left">
							 To retain their clean, smudge-free appearance all year along, all keycaps are coated with an abrasion resistance fluoride coating that is specially developed to keep fingerprints and smudges away.
						    </p> 
						</div> 
